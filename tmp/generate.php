...
tab;
			...
			else display_generate_form($p,$class_total,$sub,$branch.$class);
...
function display_generate_form($p,$max,$sub,$cl) {
	$cls = substr($cl,-1);
	echo <<< a
	<form action="?$p" method="post" onsubmit="return check_range($max);" >
	<div id="Period">
...
generate_attendance('Attendance');
?>
